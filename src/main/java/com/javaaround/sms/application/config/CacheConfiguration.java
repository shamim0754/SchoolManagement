package com.javaaround.sms.application.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("SchoolManagement");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("SchoolManagement");
        ...
        config.getMapConfigs().put("com.javaaround.sms.application.domain.*", initializeDomainMapConfig(jHipsterProperties));
